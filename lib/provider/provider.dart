...
class BikesProvider extends ChangeNotifier {
  ...
  List<BikesClass> mountainBikes = [
    BikesClass(name: 'mountain 223', picture: "bike20.webp", price: '330000'),
    BikesClass(name: 'mutual bike', picture: "bike21.webp", price: '330000'),
    BikesClass(name: 'lambo 11', picture: "bike22.webp", price: '330000'),
    BikesClass(name: 'bikes 2000cc', picture: "bike20.webp", price: '330000'),
    BikesClass(
        name: 'mountains lite 332', picture: "bike21.webp", price: '330000'),
  ];
  List<BikesClass> roadBikes = [
    BikesClass(name: 'road 7', picture: "bike30.webp", price: '330000'),
    BikesClass(name: 'river road', picture: "bike31.webp", price: '330000'),
    BikesClass(name: 'roronoa road', picture: "bike32.webp", price: '330000'),
    BikesClass(name: 'paradise', picture: "bike30.webp", price: '330000'),
    BikesClass(name: 'hell', picture: "bike31.webp", price: '330000'),
  ];
  List<BikesClass> sportBikes = [
    BikesClass(name: 'sprite', picture: "bike40.webp", price: '330000'),
    BikesClass(name: 'sport bike 22', picture: "bike41.webp", price: '330000'),
    BikesClass(name: 'srr 889', picture: "bike42.webp", price: '330000'),
    BikesClass(name: 'super main 21', picture: "bike40.webp", price: '330000'),
    BikesClass(name: 'paramedic', picture: "bike41.webp", price: '330000'),
  ];
  //  checkInput() {
  //   return null
  // }
